...
def test_encntr_er_complnt_hist(msg, insert_user_id):
    df = spark.createDataFrame(
        ...
        "returned",
        invoke_encntr_er_complaint_process(col("msg"), col("insert_user_id")),
    )
...
test_encntr_er_complnt_hist(hl7_sample, insert_user_id)
