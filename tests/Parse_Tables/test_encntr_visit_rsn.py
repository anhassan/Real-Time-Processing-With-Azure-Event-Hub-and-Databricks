...
def test_encntr_visit_rsn_hist(msg, insert_user_id):
    df = spark.createDataFrame(
        ...
        "returned",
        invoke_encntr_visit_rsn_process(col("msg"), col("insert_user_id")),
    )
...
test_encntr_visit_rsn_hist(hl7_sample, insert_user_id)