...
def invoke_adt_dtl_process(row):
    ...
    try:
        ...
        DatetimeOfBirth = pytz.timezone("US/Central").localize(
    ...
    try:
        ...
        PatientDeathDateAndTime = pytz.timezone("US/Central").localize(
    ...
    return [
        ...
        PatientClass,
        get_hosp_admsn_time(jsnmsg),
        get_hosp_disch_time(jsnmsg),
        PointOfCare,
        HierarchicDesignator,
        Room,
        Bed,
        ...
        sex,
        ModeOfArrivalCode,
        get_acuity_level(jsnmsg),
        EDDisposition,
        DischargeDisposition,
        get_adt_arrival_time(jsnmsg),
        hsp_account_id,
        AccommodationCode,
        OperatorID,
        datetime.now(),
...
adt_dtl_hist_columns = ['msg_typ','msg_src','trigger_evnt','msg_tm','msg_nm','bod_id','pat_mrn_id','pat_enc_csn_id','birth_dt','death_dt','pat_class_abbr',
...
adt_dtl_hist_schema = StructType(
    [
        ...
        StructField("adt_arvl_tm", TimestampType(), True),
